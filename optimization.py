...
def nonlinear_conjugate_gradients(oracle, x_0, tolerance=1e-4, max_iter=500,
    ...
    # 1. Use Polak-Ribiere (PR) formula for beta_k.
    # 2. Implement the restart heuristic: if beta_k < 0 or method stops descending, set beta_k = 0.
    # 3. Use line_search_tool.line_search() for step size (requires strong Wolfe conditions).
